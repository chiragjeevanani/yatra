                ...
                <div className="mt-10 space-y-4">
                    ...
                    <div className="space-y-3">
                        <motion.button
                            ...
                            className="w-full h-16 bg-card border border-border rounded-2xl flex items-center gap-4 px-6 cursor-pointer hover:bg-muted/50 transition-all active:scale-95"
                        >
                ...
                <AnimatePresence>
                    {lastAlert && (
                        <motion.div
                            ...
                            className="fixed bottom-24 left-1/2 -translate-x-1/2 w-[calc(100%-40px)] max-w-[360px] bg-driver-primary text-white p-4 rounded-2xl shadow-2xl z-[60] flex items-center gap-3 border border-white/20 backdrop-blur-md"
                        >
                            <div className="w-8 h-8 rounded-lg bg-white/20 flex items-center justify-center">
                                <Bell size={16} />
                            </div>
                            <div className="flex-1">
                                <p className="text-[10px] font-black uppercase tracking-widest opacity-60">Alert Sent</p>
                                <p className="text-xs font-bold leading-tight">{lastAlert}</p>
                            </div>
                        </motion.div>
                    )}
                </AnimatePresence>
